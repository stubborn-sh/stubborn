 ...
 *
 * <p>
 * The {@code triggerVerification()} method is referenced by the contract's
 ...
 *
 * <p>
 * {@code @AutoConfigureMessageVerifier} activates the {@code stubborn-messaging-kafka}
 ...
 * Testcontainers-managed Kafka instance via {@code @ServiceConnection}.
 */
@SpringBootTest
@AutoConfigureMessageVerifier
@Import(VerificationContractBase.KafkaContainerConfig.class)
public abstract class VerificationContractBase {
	...
	public void triggerVerification() {
		this.verificationService
			.sendVerificationResult(new VerificationResult("vrf-001", "ACCEPTED", "All checks passed"));
	}
