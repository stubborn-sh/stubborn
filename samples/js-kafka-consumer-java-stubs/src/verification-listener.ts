 ...
 *
 * This is the JS equivalent of the Java {@code VerificationListener}. In this
 * cross-language sample, the contracts are published by the **Java** kafka-producer
 * and consumed by this **JS** consumer.
 */
