...
| `description` (Gradle: `appDescription`)
| No
| --
| Application description (used during auto-registration)

| `owner`
| No
| `unknown`
| Application owner (used during auto-registration)

| `skip` (Maven property: `broker.skip`)
| No
| `false`
...
See specification: https://github.com/stubborn-sh/stubborn/blob/main/docs/specs/008-contract-publishing-plugins.md[docs/specs/008-contract-publishing-plugins.md]
